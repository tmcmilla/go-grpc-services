//go:generate mockgen -build_flags=--mod=mod -destination=rocket_mocks_test.go -package=rocket github.com/tmcmilla/go-grpc-services/internal/rocket Store
...
// our database implememtation to follow
